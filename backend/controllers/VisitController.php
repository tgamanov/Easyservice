...
class VisitController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['index', 'visit_id' => $model->visit_id, 'visit_user_id' => $model->visit_user_id, 'visit_master_id' => $model->visit_master_id, 'visit_service_id' => $model->visit_service_id]);
        } else {
